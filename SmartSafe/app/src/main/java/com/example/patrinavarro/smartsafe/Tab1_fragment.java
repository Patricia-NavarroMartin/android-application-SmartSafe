...
//    HashMap<String,Float> category_amount;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        lv=(ListView) view.findViewById(R.id.tab1_listview);
        ...
        pieChart = (PieChart) view.findViewById(R.id.tab1_pieChart);
    ...
    private void extract_fromDB() {
        ...
        final String date_txt = sqlDateFormat.format(Calendar.getInstance().getTime());
